	...
	if ($result=mysqli_query($con,$sql))
	{
		...
		foreach ($result as $sliderposts => $slideritem) {
      	# code...fetch actual category from categories table
			...
			echo '<li>
			<div class="blog-item">
			<img src="admin/images/'.$slideritem['photo'].'" alt="fantastic cms" class="img-fluid" style="width:450px;height:350px"/>
	...
	if ($result=mysqli_query($con,$sql))
	{
		...
		foreach ($result as $bloggrid => $griditem) {
      	# code...
			...
			<img src="admin/images/'.$griditem['photo'].'" class="img-fluid" alt="fantastic cms" style="width:350px;height:250px">
			</a>
			</div>
			<h3>
	...
	if ($result=mysqli_query($con,$sql))
	{
		...
		foreach ($result as $olderposts => $op) {
      	# code...
			...
			<img src="admin/images/'.$op['photo'].'" class="img-fluid" alt="fantastic cms">
			</a>
			</div>
...
function getfour($table){
	...
	if ($result=mysqli_query($con,$sql))
	{
		...
		foreach ($result as $thefour => $fourdata) {
      	# code...
			echo '<li>
			<a href="admin/images/'.$fourdata['photo'].'">
			<img src="admin/images/'.$fourdata['photo'].'" alt="fantastic cms" data-desoslide-caption="<h3>Latest Post '.$fourdata['id'].'</h3>">
	...
	if ($result=mysqli_query($con,$sql))
	{
		...
		foreach ($result as $onelatest => $onedata) {
      	# code...
			...
			<img src="admin/images/'.$onedata['photo'].'" class="img-fluid" alt="fantastic cms" style="width:900px;height:500px">
			</a>
			</div>
					...
					echo '<div class="blog-grids row mb-3">
								<div class="col-md-5 blog-grid-left">
									<a href="single.php?id='.$postdata['id'].'">
										<img src="admin/images/'.$postdata['photo'].'" class="img-fluid" alt="fantastic cms">
									</a>
								</div>
								<div class="col-md-7 blog-grid-right">
      	...
      	# code...
			echo '<div class="col-md-6 card">
							<a href="single.php?id='.$cdata['id'].'">
								<img src="admin/images/'.$cdata['photo'].'" class="card-img-top img-fluid" alt="fantastic cms" style="width:480px;height:300px">
							</a>
							<div class="card-body">
					...
					echo '<div class="blog-grids row mb-3">
							<div class="col-md-5 blog-grid-left">
								<a href="single.php?id='.$specificblog['id'].'">
									<img src="admin/images/'.$specificblog['photo'].'" class="img-fluid" alt="fantastic cms">
								</a>
							</div>
							<div class="col-md-7 blog-grid-right">
