...
<head>
	...
	<meta charset="utf-8">
	<link id="browser_favicon" rel="shortcut icon" href="admin/images/<?php geticon("titles"); ?>">
					...
					<div class="blog-grid-top">
						<div class="b-grid-top">
							<div class="blog_info_left_grid">
								<a href="#">
									<img src="admin/images/<?php echo $row['photo']; ?>" class="img-fluid" alt="image not available" style="width:800px;height:400px">
								</a>
							</div>
							<div class="blog-info-middle">
								<ul>
									...
									<p><strong>Manipuri Song Lyrics | Manipuri Eseimayek |  Manipuri Esei</strong></p>
								</div>
								<!--//left-->
								<!--right-->
											...
											<ul>
												...
												<li>
													...
													<li>
														...
														<li>
															<a class="instagram2" href="<?php getlinks("links","instagram");?>">
