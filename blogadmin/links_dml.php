...
function links_insert(){
	...
	sql('insert into `links` set       `facebook`=' . (($data['facebook'] !== '' && $data['facebook'] !== NULL) ? "'{$data['facebook']}'" : 'NULL') . ', `twitter`=' . (($data['twitter'] !== '' && $data['twitter'] !== NULL) ? "'{$data['twitter']}'" : 'NULL') . ', `instagram`=' . (($data['instagram'] !== '' && $data['instagram'] !== NULL) ? "'{$data['instagram']}'" : 'NULL') . ', `pinterest`=' . (($data['pinterest'] !== '' && $data['pinterest'] !== NULL) ? "'{$data['pinterest']}'" : 'NULL') . ', `dribble`=' . (($data['dribble'] !== '' && $data['dribble'] !== NULL) ? "'{$data['dribble']}'" : 'NULL') . ', `comments_script`=' . (($data['comments_script'] !== '' && $data['comments_script'] !== NULL) ? "'{$data['comments_script']}'" : 'NULL') . ', `sharing_script`=' . (($data['sharing_script'] !== '' && $data['sharing_script'] !== NULL) ? "'{$data['sharing_script']}'" : 'NULL') . ', `javascript`=' . (($data['javascript'] !== '' && $data['javascript'] !== NULL) ? "'{$data['javascript']}'" : 'NULL'), $o);
	if($o['error']!=''){
		echo $o['error'];
...
function links_update($selected_id){
	...
	$o=array('silentErrors' => true);
	sql('update `links` set       `facebook`=' . (($data['facebook'] !== '' && $data['facebook'] !== NULL) ? "'{$data['facebook']}'" : 'NULL') . ', `twitter`=' . (($data['twitter'] !== '' && $data['twitter'] !== NULL) ? "'{$data['twitter']}'" : 'NULL') . ', `instagram`=' . (($data['instagram'] !== '' && $data['instagram'] !== NULL) ? "'{$data['instagram']}'" : 'NULL') . ', `pinterest`=' . (($data['pinterest'] !== '' && $data['pinterest'] !== NULL) ? "'{$data['pinterest']}'" : 'NULL') . ', `dribble`=' . (($data['dribble'] !== '' && $data['dribble'] !== NULL) ? "'{$data['dribble']}'" : 'NULL') . ', `comments_script`=' . (($data['comments_script'] !== '' && $data['comments_script'] !== NULL) ? "'{$data['comments_script']}'" : 'NULL') . ', `sharing_script`=' . (($data['sharing_script'] !== '' && $data['sharing_script'] !== NULL) ? "'{$data['sharing_script']}'" : 'NULL') . ', `javascript`=' . (($data['javascript'] !== '' && $data['javascript'] !== NULL) ? "'{$data['javascript']}'" : 'NULL') . " where `id`='".makeSafe($selected_id)."'", $o);
	if($o['error']!=''){
		echo $o['error'];
